...
namespace GJ.DEV.PLC
{
    ...
    public class S7MultiVar
    {
        ...
        private CSiemems_S7 FClient;
        private GCHandle[] Handles = new GCHandle[CSiemems_S7.MaxVars];
        private int Count = 0;
        private CSiemems_S7.S7DataItem[] Items = new CSiemems_S7.S7DataItem[CSiemems_S7.MaxVars];


        public int[] Results = new int[CSiemems_S7.MaxVars];
        ...
        public S7MultiVar(CSiemems_S7 Client)
        {
            FClient = Client;
            for (int c = 0; c < CSiemems_S7.MaxVars; c++)
    ...
    public class CSiemems_S7
    {
        ...
        /// <returns></returns>
        private int SetConnectionParams(string Address, ushort LocalTSAP, ushort RemoteTSAP)
        {
        ...
        /// 读取PLC区域数据
        /// </summary>
        /// <param name="Area">S7Consts.S7Area</param>
        /// <param name="DBNumber">S7Consts.S7AreaDB有效,其他无效</param>
        /// <param name="Start">Offset</param>
        /// <param name="Amount">读取数量</param>
        /// <param name="WordLen">字长度:-->S7Consts.S7WLBit</param>
        /// <param name="Buffer">数据=Amount*WordLen</param>
        /// <returns></returns>
        ...
        {
            CSiemems_S7.S7SZL SZL = new CSiemems_S7.S7SZL();
            int Size = 256;
            SZL.Data = new byte[Size];
