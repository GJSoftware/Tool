...
namespace GJ.DEV.DD
{
    public class CDD_35V:IDD
    {

     #region 构造函数
     public CDD_35V(int idNo = 0, string name = "GJDD_35V")
     {
        _idNo = idNo;
     ...
     public bool ReadData(int wAddr, ref CrData rDataVal, out string er)
     {
         ...
         try
         {
             ...
             {
                 rDataVal.Volt[i] = ((double)(System.Convert.ToInt16(rData.Substring(i * 4, 4), 16))) / 1000;
             }
