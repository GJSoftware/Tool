...
{
    public class CDM70 : IBarCode
    {
        #region 构造函数
        public CDM70(int idNo = 0, string name = "DM70")
        {
            this._idNo = idNo;
            this._name = name;
        }
        ...
        /// <param name="er"></param>
        /// <returns></returns>
        public bool Open(string comName, out string er, string setting = "115200,E,8,1", bool recvThreshold = false)
        {
            er = string.Empty;
