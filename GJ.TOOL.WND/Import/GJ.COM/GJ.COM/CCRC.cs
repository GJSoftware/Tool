...
namespace GJ.COM
{
    ...
    public class CCRC
    {
        #region 查表法
        // CRC高位字节表
        private static readonly byte[] _crcHighOrderByteTable = new byte[]
        {
        ...
        // CRC低位字节表
        private static readonly byte[] _crcLowOrderByteTable = new byte[]
        {
        ...
        /// <returns></returns>
        public static void Cal_Crc16(byte[] buffer, out byte crcHighOrderByte, out byte crcLowOrderByte)
        {
            // CRC高位字节/低位字节
            ...
            for (int i = 0; i < buffer.Length; i++)
            {
                ...
                crcHighOrderByte = (byte)(crcLowOrderByte ^ _crcHighOrderByteTable[crcIndex]);
                crcLowOrderByte = (byte)_crcLowOrderByteTable[crcIndex];
            }
        }
        #endregion
